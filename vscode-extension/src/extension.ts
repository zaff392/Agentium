...
<body>
  ...
  <div class="input-area">
    <div class="input-wrapper">
      ...
      ></textarea>
      <button onclick="send()" id="sendBtn" aria-label="Send message" aria-busy="false">Send</button>
    </div>
  </div>
      ...
      processedContent = processedContent.replace(
        ...
        (match, lang, code) => {
          ...
          return '<pre><code class="language-' + (lang || 'text') + '">' + escapedCode + '</code>' +
            ...
            '<button onclick="copyCode(this)" aria-label="Copy code" title="Copy code">Copy</button>' +
            '<button onclick="insertCode(this)" aria-label="Insert code" title="Insert code">Insert</button>' +
            '</div></pre>';
        }
      );
