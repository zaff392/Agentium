      ...
      processedContent = processedContent.replace(
        ...
        (match, lang, code) => {
          ...
          return '<pre><code class="language-' + (lang || 'text') + '">' + escapedCode + '</code>' +
            ...
            '<button onclick="copyCode(this)" aria-label="Copy code snippet">Copy</button>' +
            '<button onclick="insertCode(this)" aria-label="Insert code snippet at cursor">Insert</button>' +
            '</div></pre>';
        }
      );
